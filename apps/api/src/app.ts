...
import { platformTenantsRoutes } from './modules/billing/platform-tenants-routes.js';
...
export function buildApp() {
  ...
  app.register(platformTenantsRoutes, { prefix: '/api/v1' });
  app.register(billingWebhookRoutes, { prefix: '/api/v1' });
  app.register(platformImpersonationRoutes, { prefix: '/api/v1' });
